...
export default function Main() {
  useEffect(() => {
    // 1️⃣ Split del texto por palabras en el h2 de la sección About
    const { words } = splitText(".main__about h2", {
      words: { wrap: "span" }, // cada palabra envuelta en <span>
    });

    // 2️⃣ Animación del texto (fade + slide up)
    ...
    timeline.add(
      ...
      stagger(60) // delay entre palabras
    );

    // 3️⃣ Fade-in secuencial de los demás elementos
