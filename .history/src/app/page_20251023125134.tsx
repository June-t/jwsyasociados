...
export default function Main() {
  useEffect(() => {
    ...
    createTimeline({
      autoplay: onScroll({
        target: document.querySelector(".main__services"),
        threshold: [0.6],
      }),
    ...
    createTimeline({
      autoplay: onScroll({
        target: document.querySelector(".main__clients"),
        threshold: [0.5],
      }),
      defaults: { duration: 1000, ease: "outExpo" },
    }).add(
      portfolioItems,
      {
        opacity: [0, 1],
    ...
    // === TEAM SECTION ===
    const teamItems = document.querySelectorAll(".main__team .team__item");
    createTimeline({
      autoplay: onScroll({
        target: document.querySelector(".main__team"),
        threshold: [0.5],
      }),
      defaults: { duration: 800, ease: "outExpo" },
    }).add(
    ...
    const contactItems = document.querySelectorAll(
      ".main__contact .contact__content, .main__contact .form__section, .main__contact .form__aside"
    );
    createTimeline({
      autoplay: onScroll({
        target: document.querySelector(".main__contact"),
        threshold: [0.5],
      }),
      defaults: { duration: 800, ease: "outExpo" },
    }).add(
