...
export default function Main() {
  ...
  const getServiceIcon = (name: string) => {
    switch (name) {
      case "briefcase":
        return <IconBriefcase color='var(--primary)' />;
      case "school":
        return <IconSchool color='var(--primary)' />;
      case "chart":
        return <IconChartBar color='var(--primary)' />;
      case "users":
        return <IconUsers color='var(--primary)' />;
      case "building":
        return <IconBuilding color='var(--primary)' />;
      case "target":
        return <IconTarget color='var(--primary)' />;
      default:
        return <IconShieldCheckFilled color='var(--primary)' />;
    }
  };
