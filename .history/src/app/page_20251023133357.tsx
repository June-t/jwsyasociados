...
export default function Main() {
  ...
  useGSAP(
    () => {
      // Configuración general para todos los grupos
      const sections = [
      ...
      sections.forEach((selector) => {
        gsap.utils.toArray(selector).forEach((el) => {
          gsap.from(el, {
            ...
            scrollTrigger: {
              trigger: el,
              start: "top 60%", // inicia cuando la parte superior del elemento llega al 60% de viewport
              end: "bottom 40%", // rango visible de activación
      ...
      // Añadimos un efecto especial para botones (pequeño rebote)
      gsap.utils.toArray(".btn__primary--search").forEach((btn) => {
        gsap.from(btn, {
          opacity: 0,
          y: 20,
          scale: 0.96,
