          ...
          <div className='team__grid--item'>
            <div className='team__item'>
              <div className='team__item--image'>
                <img
                  src='https://cmmodels.de/wp-content/uploads/2021/08/gabriel-new-face-white-shirt-brown-hair-pretty-boy-young-white-background-studio-brown-hair-wet-look-dreamy-eyes.jpg'
                  alt=''
                />
              </div>
