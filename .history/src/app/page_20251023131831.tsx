...
import { IconArrowUpRight, IconShieldCheckFilled } from "@tabler/icons-react";
...
export default function Main() {
  ...
  useGSAP(
    () => {
      // === ABOUT SECTION ===
      gsap.from(".main__about .about__content > *", {
        opacity: 0,
        y: 60,
        duration: 0.9,
        ease: "power3.out",
      ...
      // === TEAM SECTION ===
      gsap.from(".main__team .team__item", {
        opacity: 0,
        y: 50,
        duration: 0.8,
        ease: "power2.out",
    ...
    { scope: container } // todos los selectores quedan limitados a este contenedor
  );
  return (
    <div ref={container}>
