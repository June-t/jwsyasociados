      ...
      <section className='main__clients'>
        ...
        <div className='clients__grid'>
          ...
          <div className='clients__brand'>
            <div className='clients__brand--item clients__brand--item1' />
            <div className='clients__brand--item clients__brand--item2' />
            <div className='clients__brand--item clients__brand--item3' />
          </div>
          <div className='clients__grid--item'>
            <div className='clients__item'>
              <div className='clients__item--icon' />
